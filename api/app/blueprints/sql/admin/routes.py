...
from app.blueprints.sql.admin import bp
from app.blueprints.sql.admin.models import Admin
from app.blueprints.sql.admin.route_protection import admin_required
from app.blueprints.sql.admin.forms import LoginForm
from app.blueprints.sql.admin.helpers import get_form_model_attributes
...
def login():
    ...
    if form.validate_on_submit():
        admin = db.session.execute(db.select(Admin).filter_by(username=form.username.data)).scalar_one()
