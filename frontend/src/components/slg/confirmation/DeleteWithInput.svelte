<script>
    ...
    import Input from "../forms/inputs/Simple.svelte";
    ...
    export let inputRequired = "input must be equal to this string in order to call the callback"
    export let input = "";
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <div class="text-sm text-gray-500 dark:text-gray-300">
                                        <slot name="deleteInput">
                                            Type the phrase "<span class="italic text-red-500">{inputRequired}</span>" to confirm deletion
                                        </slot>
                                        <div class="flex flex-col items-center">
                                            <Input
                                                inputClasses={"w-48 mt-2 px-3 py-2 bg-inherit border border-daw-gray-300 focus:ring-primary-500 focus:border-primary-500 block text-sm sm:text-sm"}
                                            ...
                                            />
                                            {#if showError}
                                            <div class="mt-2 px-2 text-sm text-red-500">
                                                Input mismatch
                                            </div>
                                            {/if}
                                        </div>
