<script>
    ...
    function showElem(scrollY) {
        if (windowHeight + scrollY > yPosition + 200) {
            visible = true;
        }
    }
...
<div {id} bind:this={topRef}>
    {#if visible}
        <div bind:this={elem} class="flex lg:grid flex-col-reverse lg:grid-cols-12 lg:gap-x-8 lg:items-center">
            ...
            <div in:fly|local={{ x: -500, duration: 2000, easing: cubicOut }} class="mt-6 lg:mt-0 lg:row-start-1 lg:col-span-5 xl:col-span-4 lg:col-start-1">
            ...
            <div in:fly|local={{ x: 500, duration: 2000 }} class="flex-auto lg:row-start-1 lg:col-span-7 xl:col-span-8 lg:col-start-6 xl:col-start-5">
