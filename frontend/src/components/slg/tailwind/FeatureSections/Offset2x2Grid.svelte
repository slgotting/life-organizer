            ...
            <svg
                ...
                <defs>
                    <pattern id="8b1b5f72-e944-4457-af67-0c6d15a99f38" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                        <rect x="0" y="0" width="4" height="4" class="dark:text-gray-800 text-gray-200" fill="currentColor" />
                    </pattern>
                </defs>
        ...
        <div class="relative max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                <div class="lg:col-span-1">
                    <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">A better way to send money.</h2>
                </div>
                <dl class="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
                    <div>
                        <dt>
                            ...
                            <p class="mt-5 text-lg leading-6 font-medium ">Competitive rates</p>
                        </dt>
                    ...
                    <div>
                        <dt>
                            ...
                            <p class="mt-5 text-lg leading-6 font-medium ">No hidden fees</p>
                        </dt>
                        <dd class="mt-2 text-base text-gray-500">
                    ...
                    <div>
                        <dt>
                            ...
                            <p class="mt-5 text-lg leading-6 font-medium ">Instant transfers</p>
                        </dt>
                        <dd class="mt-2 text-base text-gray-500">
                    ...
                    <div>
                        <dt>
                            ...
                            <p class="mt-5 text-lg leading-6 font-medium ">Reminder emails</p>
                        </dt>
                        <dd class="mt-2 text-base text-gray-500">
